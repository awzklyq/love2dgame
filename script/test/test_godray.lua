...
local depthmap_depth_buffer = Canvas.new(w, h, {format = "depth24stencil8", readable = true, msaa = 0, mipmaps="none"})
...
app.resizeWindow(function(w, h)
    ...
    depthmap_depth_buffer = Canvas.new(w, h, {format = "depth24stencil8", readable = true, msaa = 0, mipmaps="none"})
end)
