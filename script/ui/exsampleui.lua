function love.load(arg)
    ...
    buttonA:setText("A")
    buttonA:setIcon("script/ui/img/icon_haha.png")
    ...
    buttonC:setText("C")
    buttonC:setIcon("script/ui/img/icon_haha.png")
    buttonC:setIconDir("right")
    buttonC:setAnchor(0, 0)
    content:addChild(buttonC)


    local img = UIImage:new("script/ui/img/gem.png")
    img:setPos(0, 50)
    buttonA:addChild(img)


    local label = UILabel:new("script/ui/font/visat.ttf", "Hello World!", 24)
