...
function Shader.GetWaterVSShaderCode()
    local vertexcode = ""
...
function Shader.GetWaterPSShaderCode()
...
function Shader.GetWaterShader(color, projectionMatrix, modelMatrix, viewMatrix)
    local directionlights = Lights.getDirectionLights()
    
    local normalmap = RenderSet.getNormalMap()
    local shader = ShaderObjects["watershader".."directionlights"..#directionlights.. (normalmap and "normalmap" or "") ..  (RenderSet.GetPBR() and "PBR" or "")]
    if shader then
    ...
    shader = Shader.new(Shader.GetWaterPSShaderCode(), Shader.GetWaterVSShaderCode())
    ...
    ShaderObjects["watershader".."directionlights"..#directionlights.. (normalmap and "normalmap" or "") ..  (RenderSet.GetPBR() and "PBR" or "")] = shader
    return  shader
end
