...
function Frustum.buildDrawLines(camera3d)
	...
	for i = 1, 8 do
		-- Verts[i] = mat:mulLeftVector3(Verts[i])
...
function Frustum:buildFromViewAndProject(V, P )
	...
	-- vp:transposeSelf()
	self.vs[1] = vp:mulLeftVector3(Vector3.new( -1.0, -1.0, 0.0 ));
	self.vs[2] = vp:mulLeftVector3(Vector3.new( -1.0,  1.0, 0.0 ));
	self.vs[3] = vp:mulLeftVector3(Vector3.new(  1.0,  1.0, 0.0 ));
	self.vs[4] = vp:mulLeftVector3(Vector3.new(  1.0, -1.0, 0.0 ));
	self.vs[5] = vp:mulLeftVector3(Vector3.new( -1.0, -1.0, 1.0 ));
	self.vs[6] = vp:mulLeftVector3(Vector3.new( -1.0,  1.0, 1.0 ));
	self.vs[7] = vp:mulLeftVector3(Vector3.new(  1.0,  1.0, 1.0 ));
	self.vs[8] = vp:mulLeftVector3(Vector3.new(  1.0, -1.0, 1.0 ));
